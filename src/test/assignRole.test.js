...
it('Should return error of not super admin', (done) => {
  request(server)
    ...
    .set(
      'token',
      'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwiZW1haWwiOiJmYW50YXN0aWNAZ21haWwuY29tIiwiaWF0IjoxNTgwMzcxNTE3fQ._geQhookj-O9nZ5cHVuQa6pFNyriZ48gVisYhEAzj38'
    )
    .send({
...
it('Should return object with new role', (done) => {
  request(server)
    ...
    .set(
      'token',
      'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJmYW50YXN0aWM3QGdtYWlsLmNvbSIsImlhdCI6MTU4MDI0MDc1NH0.frkJkunuF3yxtaIqIQYe-yo2nA5SF4WrPUmxuvb5sYs'
    )
    .send({
      role: 'super-administrator',
