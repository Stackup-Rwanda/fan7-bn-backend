 ...
 */
  ...
  static tripRequest(data) {
    const schema = Joi.object({
      ...
      gender: Joi.string().trim().required().valid(
        'Male', 'Female'
      ),
      role: Joi.string()
        .trim()
      ...
      from: Joi.string()
        .required()
        .messages({
          'string.base': 'Place you are leaving from must be string',
          'any.required': 'Place you are leaving from is required',
          'string.empty': 'Place you are leaving from is not allowed to be empty'
        }),
      to: Joi.string()
        .required()
        .messages({
          'string.base': 'Place you are going to must be string',
          'any.required': 'Place you are going to is required',
          'string.empty': 'Place you are going to is not allowed to be empty'
        }),
      travelTime: Joi.date()
        .messages({
          'date.base': 'Travel time must be a date',
        }),
      reason: Joi.string()
        .required()
        .messages({
      ...
      accommodation: Joi.string()
        .required()
        .messages({
          'string.base': 'Accomodation must be string',
          'any.required': 'Accomodation is required',
          'string.empty': 'Accomodation is not allowed to be empty'
        }),
